...
def probiou(obb1, obb2, CIoU=False, eps=1e-7):
    ...
    #     obb1 = Polygon(obb1[:8].reshape((4, 2)))
    #     obb2 = Polygon(obb2[:8].reshape((4, 2)))c
    #     if not obb1.is_valid or not obb2.is_valid:
    #         return 0
    #     inter = Polygon(obb1).intersection(Polygon(obb2)).area
    #     union = obb1.area + obb2.area - inter
    #     if union == 0:
    #         return 0
    #     else:
    #         return inter/union
...
class ConfusionMatrix:
    ...
    def process_batch(self, detections, gt_bboxes, gt_cls):
        ...
        # print(f"detections.shape[0]: {detections.shape[0]}")
        # print(f"detections.shape[1]: {detections.shape[1]}")
        # print("-----------------------------------------------------------------------------------------")
        is_obb = (
